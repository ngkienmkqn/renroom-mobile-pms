        ...
        <Drawer.Portal>
          ...
          <Drawer.Content className="fixed bottom-0 left-0 right-0 z-[100] bg-slate-50 dark:bg-slate-900 flex flex-col rounded-t-[32px] h-[85vh] outline-none">
            ...
            <div className="max-w-5xl w-full mx-auto flex flex-col px-6 pb-12 overflow-y-auto flex-1 min-h-0">
              ...
              <h3 className="text-xs font-extrabold uppercase tracking-wider text-slate-400 mb-3 px-1 mt-6">Đồng bộ Lịch</h3>
              <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-700 overflow-hidden mb-8">
                <a 
                  href="webcal://renroom-mobile-pms.vercel.app/api/ical"
                  className="w-full flex items-center justify-between p-4 active:bg-slate-50 dark:active:bg-slate-700/50 transition-colors"
                >
                  <div className="flex items-center gap-3">
